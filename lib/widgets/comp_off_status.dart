...
class CompOffStatus extends StatefulWidget {
  final double leftPadding = 25.0;
  final String title;

  const CompOffStatus({Key key, @required this.title}) : super(key: key);

  @override
  _CompOffStatusState createState() => _CompOffStatusState();
}

class _CompOffStatusState extends State<CompOffStatus> {
  @override
