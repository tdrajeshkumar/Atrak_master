  ...
  void initState() {
    ...
    _viewModel = ViewModel(
        ...
        color: (widget.currentState == null ||
            ...
            ? AtrakTheme.checkInButtonColor
            : AtrakTheme.checkOutButtonColor,
                  ...
                  children: <Widget>[
                    Container(
                        decoration: BoxDecoration(
                            color: AtrakTheme.checkInBackgroundColor,
                      ...
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: Theme.of(context).textTheme.display1.copyWith(
                              fontSize: 18.0, color: AtrakTheme.slideTextColor),
                        ),
                      ),
                    ),
                    GestureDetector(
      ...
      ..addStatusListener((status) {
        if (status == AnimationStatus.completed) {
          if (viewModel.stateChanged != null) {
            print("sending the view state");
            viewModel.stateChanged(viewModel.currentState);
          }else{
            print("View State is null");
          }
          dispose();
        }
      });
